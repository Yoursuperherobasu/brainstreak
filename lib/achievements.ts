...
export const ACHIEVEMENTS: Achievement[] = [
  {
    ...
    predicate: (s) => s.profile.gamesPlayed >= 1,
  },
  {
    id: 'level-3',
    title: 'Getting somewhere',
    description: 'Reach level 3.',
    predicate: (s) => s.profile.level >= 3,
  },
  {
    id: 'level-5',
    title: 'Knowledge worker',
    description: 'Reach level 5.',
    predicate: (s) => s.profile.level >= 5,
  },
  {
    id: 'level-10',
    title: 'Quiz machine',
    description: 'Reach level 10.',
    predicate: (s) => s.profile.level >= 10,
  },
  {
    id: 'week-streak',
    title: 'On fire',
    description: 'Hold a 7-day streak.',
    predicate: (s) => s.streak.current >= 7,
  },
  {
    id: 'month-streak',
    title: 'Unstoppable',
    description: 'Hold a 30-day streak.',
    predicate: (s) => s.streak.current >= 30,
  },
  {
    id: 'centurion',
    title: 'Centurion',
    description: 'Play 100 rounds.',
    predicate: (s) => s.profile.gamesPlayed >= 100,
  },
  {
    id: 'xp-1k',
    title: 'Cool 1,000',
    description: 'Earn 1,000 XP.',
    predicate: (s) => s.profile.totalXP >= 1000,
  },
  {
    id: 'perfect-round',
    title: 'Flawless',
    description: 'Get every answer right in a round.',
    predicate: (s) => s.recent.some((g) => g.total > 0 && g.correct === g.total),
  },
];
